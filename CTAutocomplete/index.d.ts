...
declare global {
  ...
  declare interface JavaTypePath {
    ...
    (
      path: "net.minecraft.client.entity.EntityPlayerSP",
    ): typeof MCEntityPlayerSP;
    ...
    (
      path: "net.minecraft.client.multiplayer.WorldClient",
    ): typeof MCWorldClient;
    ...
    (
      path: "net.minecraftforge.client.event.MouseEvent",
    ): typeof ForgeMouseEvent;
    (
  ...
  declare interface IRegister {
    ...
    (
      ...
      method: Parameters<
        ITriggerRegister["registerRenderItemOverlayIntoGui"]
      >[0],
